...
function ResultFormat(props) {
    ...
    if (props.searchType === 'Films') {
        return (
            ...
            <div  class="flex w-full h-24 font-montserrat my-2 cursor-pointer">
    ...
    if (props.searchType === 'Journals') {
        return (
            <div onClick={() => history.push('/' + props.username + '/movies/' + props.result.id)} class="flex w-full h-24 font-montserrat my-2 cursor-pointer">
