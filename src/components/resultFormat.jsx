...
function ResultFormat(props) {
    ...
    if (props.searchType === 'Films') {
        return (
            props.result.poster_path ?
                <div class="flex w-full h-32 font-montserrat cursor-pointer hover:bg-gray-100 p-2 transition duration-300" onMouseOver={() => setHover(true)} onMouseLeave={() => setHover(false)}>
    ...
    if (props.searchType === 'Users') {
        return (
            <div onClick={() => history.push('/' + props.result.username)} class="flex w-full h-32 mb-3 px-3 cursor-pointer transition duration-300 hover:bg-gray-100">
    ...
    if (props.searchType === 'Journals') {
        return (
            <div onClick={() => history.push('/' + props.username + '/movies/' + props.result.id)} class="flex w-full h-32 p-2 my-1 cursor-pointer transition duration-300 hover:bg-gray-100">
