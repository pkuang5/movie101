...
function Introduction(props) {
    ...
    return (
        <div class="flex flex-col w-full">
            ...
            <div class="flex items-center font-yeseva mb-20">
            ...
            <div class="flex flex-col justify-between w-full h-screen bg-cover bg-local bg-center px-12 py-10" data-aos="zoom-in" style={{backgroundImage: "url('" + backgroundImage + "')"}}>
                <div class="flex w-full justify-end">
                    <p class="text-5xl text-right font-yeseva text-white"> Create journals to remember<br></br> your favorite shots.</p>
                </div>
            ...
            <div class="flex lg:text-4xl md:text-2xl sm:text-lg text-md py-20 font-yeseva">
                ...
                <div class="flex w-2/5 justify-start" data-aos="fade-up">
            ...
            <div class="flex w-full">
                <div class="flex justify-end items-center lg:text-lg sm:text-md text-xs w-1/2 font-montserrat"  data-aos="fade-up">
                    <div class="w-4/5 lg:text-lg md:text-md sm:text-sm text-mobile" >
