    ...
    render () {
        ...
        return (
            <div ref = {node => this.node = node} class= "h-10 object-bottom ">
                <input id = "searchBar" class = "h-full rounded  cursor-pointer w-full " value = {text} onChange = {this.onTextChanged} type = "text" placeholder = {this.props.name?this.props.name:null}/>
