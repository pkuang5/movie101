                ...
                <div class="flex flex-col w-screen items-center mt-3">
                    <div class="flex flex-col w-2/3 items-center">
                        <div class="flex flex-col items-center w-full">
                            ...
                            <p class="font-montserrat text-center"> Welcome, {this.state.firstName}! This is your feed. <br></br> See what movies are popular in the Screenbook community and follow other members to see their journals. Or, get started on your own journal. </p>
