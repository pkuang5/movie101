            ...
            <React.Fragment>
                ...
                <div class="flex justify-center pt-3 w-full">
                    <div class="text-center w-2/3">
                        ...
                        <p class="font-montserrat"> Welcome, Kari! This is your feed. <br></br> See what movies are popular in the Screenbook community and follow other members to see their journals. Or, get started on your own journal. </p>
                    </div>
                </div>
